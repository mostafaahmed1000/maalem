...
@section('header_actions')
    <a href="{{ route('admin.instructors.create') }}" class="btn-primary-action"
        style="padding: 0.8rem 1.5rem; background: var(--primary); color: #fff; text-decoration: none; border-radius: 12px; font-weight: 700; display: flex; align-items: center; gap: 8px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="text-align: left; border-bottom: 2px solid var(--border);">
                        <th
                            style="padding: 1.2rem; color: var(--text-muted); font-size: 0.85rem; text-transform: uppercase;">
                            Instructor</th>
                        <th
                            style="padding: 1.2rem; color: var(--text-muted); font-size: 0.85rem; text-transform: uppercase;">
                            Rating</th>
                        <th
                            ...
                            Status</th>
                        <th
                            style="padding: 1.2rem; color: var(--text-muted); font-size: 0.85rem; text-transform: uppercase; text-align: right;">
                            Actions</th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <td style="padding: 1.2rem; text-align: right;">
                                <div style="display: flex; justify-content: flex-end; gap: 10px;">
                                    <a href="{{ route('admin.instructors.edit', $instructor) }}"
                                        style="color: var(--primary);"><i class="fas fa-edit"></i></a>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" style="padding: 3rem; text-align: center; color: var(--text-muted);">No instructors
                                found. Click "Add Instructor" to create one.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
