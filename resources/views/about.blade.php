...
<body>
    ...
    <main class="about-page">
                ...
                <div class="about-hero-flex" style="display: flex; align-items: center; gap: 4rem; flex-wrap: wrap;">
                    <div style="flex: 1; min-width: 300px;" class="reveal reveal-left">
                        ...
                        <p data-i18n="about_p1">
                            Maalem Educational Services is led by a distinguished board of education professionals whose
                            individual experience ranges from 20 to over 35 years in the field of education. This depth
                            of expertise is reflected in a strong track record of leadership across teaching, school
                            management, strategic development, and institutional transformation.
                        </p>
                        <P>
                            Our board members have played pivotal roles in the establishment, operation, and leadership
                            of schools across Alexandria, Cairo, and the Kingdom of Saudi Arabia, working with diverse
                            educational systems including national and international curricula. Their experience spans
                            the full educational journey—from classroom teaching to executive leadership—bringing both
                            practical insight and strategic vision to every project.
                        </p>
                        <P>
                            With extensive involvement in school governance, accreditation processes, curriculum
                            development, and performance management, the team has successfully supported institutions in
                            achieving and maintaining high standards of educational quality. Their work includes leading
                            accreditation cycles, designing improvement frameworks, and fostering cultures of continuous
                            growth and accountability within schools.
                        </p>
                        <P>
                            Beyond individual institutions, Maalem’s impact extends across the broader education
                            landscape. The team has contributed to the development and enhancement of over 160 schools
                            across Egypt and Saudi Arabia, supporting schools in strengthening their systems, improving
                            learning outcomes, and adapting to evolving educational demands.
                        </p>
                        <P> At the heart of Maalem’s philosophy is a commitment to a holistic, student-centered
                            approach. We believe that education goes beyond academics, encompassing well-being, personal
                            development, critical thinking, and community engagement. Our work focuses on building
                            integrated educational ecosystems where students, educators, and leaders thrive
                            together—ensuring sustainable growth and meaningful, long-term impact.
                        </p>
                    </div>
        ...
        <section class="merged-services-section about-identity-section" id="ecosystem" style="background: #f8fafc;">
            <div class="container">
                <div class="merged-services-header reveal" style="text-align: center; margin-bottom: 4rem;">
                    ...
                    <h2 data-i18n="who_title" style="font-size: 2.8rem; font-weight: 800; color: var(--text-color);">
                        Who
                        We Are</h2>
                </div>
                    ...
                    <div class="reveal" style="margin-bottom: 4rem;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 3rem; margin-bottom: 4rem;"
                            ...
                            <div class="about-grid-card"
                                ...
                                <h3 data-i18n="about_card1_h"
                                    ...
                                    Transformation</h3>
                                <p data-i18n="about_card1_p" style="color: var(--text-light); line-height: 1.7;">
                                    Rooted in
                                    strong academic and professional backgrounds, the team brings expertise in
                                    educational
                                    leadership, research-based pedagogy, organizational culture, data-driven
                                    decision-making, and institutional transformation. Their work has consistently
                                    focused
                                    on improving learning outcomes while building strong, values-driven school
                                    communities.
                                </p>
                            </div>
                            <div class="about-grid-card"
                                ...
                                <p data-i18n="about_card2_p" style="color: var(--text-light); line-height: 1.7;">
                                    Beyond
                                    individual institutions, Maalem plays an active role in the broader education
                                    landscape,
                        ...
                        <div class="reveal reveal-right"
                            ...
                            <div class="category-header reveal" style="text-align: center; margin-bottom: 3rem;">
                                ...
                                <h2 data-i18n="values_title" style="font-size: 2.5rem; font-weight: 700; margin: 0;">
                                    Core
                                    Values</h2>
                            </div>

                            <div style="display: grid; grid-template-columns: repeat(5, minmax(240px, 1fr)); gap: 2rem; padding: 0 2rem; justify-content: center;"
                                class="reveal">
                                <div class="cat-card"
                                    ...
                                    <h3 data-i18n="val1_h"
                                        style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem;">Excellence
                                    </h3>
                                    <p data-i18n="val1_p"
                                ...
                                <div class="cat-card"
                                    ...
                                    <h3 data-i18n="val2_h"
                                        style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem;">Innovation
                                    </h3>
                                    <p data-i18n="val2_p"
                                        style="color: var(--text-light); font-size: 0.95rem; line-height: 1.6; margin: 0;">
                                ...
                                <div class="cat-card"
                                    ...
                                    <h3 data-i18n="val3_h"
                                        style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem;">Integrity
                                    </h3>
                                    <p data-i18n="val3_p"
                                        style="color: var(--text-light); font-size: 0.95rem; line-height: 1.6; margin: 0;">
                                ...
                                <div class="cat-card"
                                    ...
                                    <h3 data-i18n="val4_h"
                                        style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem;">
                                        Collaboration
                                    </h3>
                                    <p data-i18n="val4_p"
                                        style="color: var(--text-light); font-size: 0.95rem; line-height: 1.6; margin: 0;">
                                ...
                                <div class="cat-card"
                                    ...
                                    <h3 data-i18n="val5_h"
                                        style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem;">Inclusivity
                                    </h3>
                                    <p data-i18n="val5_p"
                                        style="color: var(--text-light); font-size: 0.95rem; line-height: 1.6; margin: 0;">
                        ...
                        <div class="reveal about-vision-box"
                            ...
                            <h2 data-i18n="about_vision_h"
                                style="font-size: 2.2rem; font-weight: 800; margin-bottom: 1.5rem;">One Cohesive Vision
                            </h2>
                            <p data-i18n="about_vision_p" style="font-size: 1.2rem; line-height: 1.8; opacity: 0.9;">
                                ...
                                socially, and emotionally—by aligning leadership, teaching practices, operational
                                systems,
                                and community engagement into one cohesive vision. We work with schools to create
                                environments where students thrive, educators grow, and institutions achieve lasting
                                impact.
                            </p>
                        </div>
                    </div>
