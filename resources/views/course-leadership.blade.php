                        ...
                        <div class="course-header-content">
                            ...
                            <div class="course-meta-bar">
                                <div class="meta-item">
                                    ...
                                    <div class="meta-text">
                                        <span>Level</span>
                                        <strong>Executive Diploma</strong>
                                    </div>
                                </div>
                                <div class="meta-item">
                ...
                <div class="course-sidebar">
                    <div class="summary-card">
                        ...
                        <ul class="summary-list">
                            <li><span>Total Credits</span> <strong>120 Credits</strong></li>
                            <li><span>Mode</span> <strong>Executive / Blended</strong></li>
                            <li><span>Language</span> <strong>English</strong></li>
                            <li><span>Mentorship</span> <strong>Included</strong></li>
                        </ul>
                        <a href="{{ url('/training/apply') }}" class="btn-enroll">APPLY FOR LEADERSHIP</a>
                    </div>
                </div>
            </div>
        </div>
