...
<head>
    ...
    <style>
        .careers-hero {
            ...
            background: #fff;
            text-align: center;
            min-height: auto !important; /* Override global 100vh */
        }
        .careers-hero h2 {
            color: #1d63dc; /* Branded Blue */
            font-size: 1.5rem;
            font-style: italic;
            margin-bottom: 1rem;
        }
        ...
        .careers-search-section {
            padding-bottom: 6rem;
            background: #fff;
            margin-top: -1rem; /* Pull search section up */
            min-height: auto !important; /* Override global 100vh */
        }
        .search-container {
            max-width: 1100px;
        ...
        @media (max-width: 992px) {
            ...
            .job-item { grid-template-columns: 1fr; gap: 0.5rem; }
            .job-type { text-align: left; }
            .resume-banner { flex-direction: column; text-align: center; }
            .resume-text { padding-right: 0; margin-bottom: 2rem; }
        }
    </style>
</head>
<body>
    ...
    <main>
        <section class="careers-hero">
            <div class="container">
                ...
                <p data-i18n="careers_hero_desc">We welcome educators, administrators, and professionals across all departments to join the Maalem community!</p>
            </div>
        </section>
                ...
                <div class="search-container">
                    ...
                    <div class="job-list">
                        ...
                        <div style="text-align: center; padding: 4rem 0; color: #64748b;">
                            <i class="fas fa-search" style="font-size: 3rem; margin-bottom: 1rem; display: block; opacity: 0.2;"></i>
                    ...
                    <div class="resume-banner">
                        <div class="resume-text">
                            “If you don't find a role that matches your profile, you can still send us your CV. We'll contact you when a suitable opportunity becomes available.”
                        </div>
