...
<div class="dashboard-grid" style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin-top: 2rem;">
    <div class="card">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
            ...
            <a href="{{ route('admin.partnerships') }}" style="color: var(--primary); font-weight: 700; text-decoration: none; font-size: 0.9rem;">View All</a>
        </div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid var(--border);">
                        ...
                        <td style="padding: 1rem 0;"><a href="{{ route('admin.submissions.show', ['type' => 'partnership', 'id' => $item->id]) }}" style="color: var(--primary);"><i class="fas fa-eye"></i></a></td>
                    </tr>
                    @empty
                    <tr>
    ...
    <div class="card">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
            <h3 style="font-weight: 800;">Recent Consultations</h3>
            <a href="{{ route('admin.consultations') }}" style="color: var(--primary); font-weight: 700; text-decoration: none; font-size: 0.9rem;">View All</a>
        </div>
        <div class="activity-list">
            ...
            <div class="activity-item" style="display: flex; gap: 12px; margin-bottom: 1.5rem;">
                ...
                <div class="activity-content">
                    <a href="{{ route('admin.submissions.show', ['type' => 'consultation', 'id' => $item->id]) }}" style="text-decoration: none; color: inherit;">
